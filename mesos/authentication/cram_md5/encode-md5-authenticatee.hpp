...
class EncodeMD5CRAMMD5Authenticatee : public Authenticatee
{
public:
  // Factory to allow for typed tests.
  static Try<Authenticatee*> create();

  EncodeMD5CRAMMD5Authenticatee();

  virtual ~EncodeMD5CRAMMD5Authenticatee();
...
private:
  EncodeMD5CRAMMD5AuthenticateeProcess* process;
};
